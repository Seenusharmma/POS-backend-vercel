  ...
  return (
    <div className="flex-1 md:flex h-full">
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-orange-50/30 via-transparent to-amber-50/20 pointer-events-none" />
            ...
            <div className="flex items-center gap-1.5 sm:gap-2 md:gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[9px] sm:text-[10px] md:text-xs text-gray-500 mt-0.5">
                  {selectedCategoryFoods.length}{" "}
                  {selectedCategoryFoods.length === 1 ? "item" : "items"}
                  {foodFilter && (
                    ...
                    >
                      <div className="flex gap-2 md:gap-3 lg:gap-4 p-2 md:p-3 lg:p-4">
                        <div className="relative flex-shrink-0 w-16 h-16 md:w-24 md:h-24 lg:w-28 lg:h-28 
                          ...
                          />
                          <div
                            className={`absolute top-1 left-1 md:top-2 md:left-2 px-1.5 md:px-2 py-0.5 md:py-1 
                      ...
                      <div className="relative h-12 sm:h-14 md:h-16 lg:h-20 w-full overflow-hidden rounded-md sm:rounded-lg md:rounded-xl">
                        ...
                        <div className="absolute inset-0 flex items-center justify-between px-2 sm:px-2.5 md:px-3 py-1.5 sm:py-2 md:py-2.5 z-10">
                          <div className="flex items-center gap-1.5 sm:gap-2 md:gap-2.5 flex-1 min-w-0">
                            <div className="text-base sm:text-lg md:text-xl lg:text-2xl transition-transform duration-300 shrink-0 group-hover:scale-110">
                              {categoryIcon}
                            </div>
                            <div className="flex flex-col min-w-0 flex-1">
                              <span className="capitalize text-xs sm:text-sm md:text-base font-bold truncate leading-tight text-white">
                                {cat.name}
                              </span>
                              <span className="text-[8px] sm:text-[9px] md:text-[10px] lg:text-xs font-medium mt-0.5 text-white/80">
                                {cat.count} {cat.count === 1 ? "item" : "items"}
                              </span>
                            </div>
                          </div>
                          <motion.div
                            className="shrink-0 transition-all duration-300 ml-0.5 sm:ml-1 text-white/70 group-hover:text-white"
